...
if ($conn) {
    ...
    $query = "SELECT * FROM Contractorbot WHERE messages LIKE '%$user_messages%'";
    ...
    if (mysqli_num_rows($runQuery) > 0) {
        ...
        echo "I'm sorry, I'm not sure what you are asking for. Can you please provide more context or clarify your question?<br/>
		<br/>Choose the appropriate word for your query:
		<br>
		<br>- General Inquiry
